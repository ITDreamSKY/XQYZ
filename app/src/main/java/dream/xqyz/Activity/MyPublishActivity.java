 ...
 */
public class MyPublishActivity extends BaseActivity implements BaseInterface {

    //xlistview
    @ViewInject(R.id.act_mypublish_xlistview)
    ...
    public void initData() {
        CommodityUtil.findCommodity(5, 3, null, new FindListener<Commodity>() {
            @Override
        ...
        xListView.setXListViewListener(new XListView.IXListViewListener() {
            ...
            public void onLoadMore() {
                CommodityUtil.findCommodity(5, 4, commodityList.size(), new FindListener<Commodity>() {
                    @Override
                    public void done(List<Commodity> list, BmobException e) {
    ...
    @OnClick(R.id.act_mypublish_backLin)
